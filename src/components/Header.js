            ...
            <div className="relative">
              ...
              {servicesOpen && (
                <ul className="absolute left-0 mt-2 w-64 bg-white border rounded-md shadow-lg">
                  <li><Link href="/services#planning-scheduling" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Planning & Scheduling</Link></li>
                  <li><Link href="/services#cost-controls" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Cost Controls</Link></li>
                  <li><Link href="/services#executive-reporting" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Executive Reporting & Dashboards</Link></li>
                  <li><Link href="/services#risk-management" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Risk Management & Claims Avoidance</Link></li>
                </ul>
              )}
            </div>
